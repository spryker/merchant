 ...
 */
class UniqueEmailMerchantValidatorPlugin extends AbstractPlugin implements MerchantValidatorPluginInterface
{
    /**
     * {@inheritDoc}
     * - Validates that `MerchantTransfer.email` is not used by another merchant.
     *
     * @api
     *
    ...
    public function validate(MerchantTransfer $merchantTransfer): MerchantResponseTransfer
    {
        return $this->getBusinessFactory()
            ->createUniqueEmailMerchantValidator()
