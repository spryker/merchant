 ...
 */
class UniqueMerchantReferenceMerchantValidatorPlugin extends AbstractPlugin implements MerchantValidatorPluginInterface
{
    /**
     * {@inheritDoc}
     * - Validates that `MerchantTransfer.merchantReference` is not used by another merchant.
     *
     * @api
     *
    ...
    public function validate(MerchantTransfer $merchantTransfer): MerchantResponseTransfer
    {
        return $this->getBusinessFactory()
            ->createUniqueMerchantReferenceMerchantValidator()
